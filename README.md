...
1. **Mathematical Modeling:** The non-linear equations of motion of the system were derived and then linearized using the small-angle approximation
(sin(θ) ≈ θ, cos(θ) ≈ 1, (dθ/dt)^2 ≈ 0).
